...
// these variables let the fancy logo on our the page function properly
var state = 0;
var logoRotateAry = ['show-front', 'show-back', 'show-right', 'show-left', 'show-top', 'show-bottom'];
...
// This function handles what happens when the logo is clicked
var clickBox = function() {
  $("#logo").on("click", function() {
    ...
    // add the proper states to the logo based on where it's clicked
    $('#logo').removeClass().addClass(logoRotateAry[state]);
